...
== Changelog ==
= 5.2.4 =
* Fixed: Broken feed header logo
* Fixed: Broken dashboard connected pages logo
* Tested: FontAwesome compbalitity, Works fine
...
== Upgrade Notice ==
= 5.2.4 =
Fixed Broken feed header logo == Fixed broken dashboard connected pages logo == Tested FontAwesome compbalitity, Works fine