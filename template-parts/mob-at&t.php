...
<i style="font-size:12px" class="fa"  title="According to 57% user recommendation rating.">&#xf059;</i></span></div>
          ...
          <div class="testimonials-caption col-lg-9 col-md-8">
            <div class="user_text ">
              <p class="mbr-fonts-style  display-7"><span><button class="btn btn-primary btn-xs"  data-toggle="collapse" href="#mobile-info" role="button" aria-expanded="false" aria-controls="resi-info">MOBILE BROADBAND</button></span></br>AT&T Wireless is a mobile internet service provider which offers service to 100% of the population in <?php echo $product->get_name(); ?>.</p>
            </div>
