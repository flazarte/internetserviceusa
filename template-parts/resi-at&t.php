    ...
    <div class="testimonials-item" >
        <div class="user row">
          <div class="col-lg-3 col-md-4">
            <div class="user_image"><a href="https://www.att.com/tv/u-verse.html" target="_blank" rel="nofollow">
          ...
          <div class="testimonials-caption col-lg-9 col-md-8">
            ...
            <?php  if( have_rows('body_content') ):
              ...
              $per_city_coverage = get_sub_field('per_city_coverage');
                ...
                ?>
              <p class="mbr-fonts-style  display-7"><span><button class="btn btn-primary btn-xs"  data-toggle="collapse" href="#resi-info" role="button" aria-expanded="false" aria-controls="resi-info">DSL</button></span><span><button class="btn btn-primary btn-xs" data-toggle="collapse" href="#resi-info" role="button" aria-expanded="false" aria-controls="resi-info">IPBB</button></span></br>AT&T U-Verse is an internet service provider offering DSL coverage to <?php echo  $per_city_coverage;?>% of <?php echo $product->get_name(); ?>. In addition to internet, they also offer home phone service.</p>
              <?php endwhile; ?>
              <?php endif; ?>
            </div>  
