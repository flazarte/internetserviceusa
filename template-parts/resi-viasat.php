 ...
 <div class="testimonials-item">
        <div class="user row">
          <div class="col-lg-3 col-md-4">
            <div class="user_image"><a href=" https://www.viasat.com/" target="_blank" rel="nofollow">
...
<i style="font-size:12px" class="fa" data-toggle="tooltip" data-placement="bottom" title="According to 35% user recommendation rating.">&#xf059;</i></span></div>
          ...
          <div class="testimonials-caption col-lg-9 col-md-8">
            <div class="user_text ">
               <?php  if( have_rows('viasat_body_content') ):

              while( have_rows('viasat_body_content') ): the_row();

              $per_city_coverage = get_sub_field('per_city_coverage');
  

                ?>
              <p class="mbr-fonts-style  display-7"><span><button class="btn btn-primary btn-xs" data-toggle="collapse" href="#viasat-info" role="button" aria-expanded="false" aria-controls="resi-info">SATELLITE</button></span></br>Viasat provides internet using satellite technology coverage of <?php echo  $per_city_coverage;?>%.</p>
              <?php endwhile; ?>
              <?php endif; ?>
            </div>
  ...
  <div class="card-body ex">
    ...
    VIASAT INTERNET IN <?php echo $product->get_name(); ?>
  </div>
...
VIASAT INTERNET PLANS
  ...
  <ul class="list-group list-group-flush">
   ...
   <?php  if( have_rows('viasat_body_content') ):
              ...
              $viasat_internet_plans = get_sub_field('viasat_internet_plans');
  
                echo $viasat_internet_plans;
                ?>
 ...
 <?php endif; ?>
  ...
  <div class="row align-center">
    <div class="col"><p><small>City Coverage</small></p>
      <div class="progress">
        <?php
        if( have_rows('viasat_body_content') ):
...
<div class="row">
  <div class="col-sm-8">
      ...
      <div class="card ex">
  <h5 class="card-header">VIASAT ACCESS IN <?php echo $product->get_name(); ?></h5>
  <div class="card-body">
    <p class="card-text">Viasat is a satellite internet provider with service available to <?php echo $product->get_name(); ?>.</p>
  </div>
</div>
  </div>
